...
//!
//! It also contains quality of life functions and specific methods/getters which
//! may come handy.
//!
//! As you can see when looking the structures of this lib, I'm avoiding to use `Vec<T>` type and
//! instead use `Box[T]`. Why ? (You should be asking yourself if you dont know why). 
//!
...
//!
//! Anyways, if you feel like adding elements the boxes you can convert them to vecs
//! by using:
//!
//! ```rust no_run
